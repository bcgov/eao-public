...
class CommonLinkModule extends Module {
  def clickSideBarLink(Map<String, Object> sectionSelector, Map<String, Object> itemSelector) {
    def item = $("aside").$("section").children(sectionSelector.tag, text:sectionSelector.text).parent().$(itemSelector, "a")
    item.click()
  }

  def clickMainContentLink(Map<String, Object> sectionSelector, Map<String, Object> itemSelector) {
    def item = $("main").$("section").children(sectionSelector.tag, text:sectionSelector.text).parent().$(itemSelector, "a")
    item.click()
  }
}
